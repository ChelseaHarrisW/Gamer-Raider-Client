...
//the useState below is deconstructing the object that will be sent via the POST HTTP request 
...
//fetching categories for the  dropdown above

// the function below is changing transient game state this is how the info is held before clicking the save button
        ...
        <form className="game__form">
            ...
            <button type="submit"
                onClick={evt => {
                    ...
                    createGame(game) //the create game fx is how the game is being posted to the back end
